...
export default function EmailModulePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      {/* Header */}
      <div className="mb-8">
        <Link href="/modulos" className="text-blue-600 hover:text-blue-800 text-sm flex items-center gap-1 mb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">E-mail Corporativo</h1>
            <p className="text-gray-600">{emailScenarios.length} cenários disponíveis</p>
          </div>
        </div>
      </div>

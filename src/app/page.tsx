    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
          ...
          <span className="text-blue-600"> ataques de phishing</span>
        </h1>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="text-center">
            <CardContent>
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Escolha um módulo</h3>
          ...
          <Card className="text-center">
            <CardContent>
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Analise a simulação</h3>
              <p className="text-gray-600 text-sm">
          ...
          <Card className="text-center">
            <CardContent>
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Aprenda com o feedback</h3>
              <p className="text-gray-600 text-sm">
      ...
      <section className="mb-16">
        ...
        <Card variant="elevated" padding="lg">
          <CardContent>
            <blockquote className="text-lg text-gray-700 italic text-center max-w-3xl mx-auto">
